...
def run_linear(
    ...
    """
    layer = Linear(d_in, d_out, weights, device=in_features.device)
...
def run_multihead_self_attention(
    ...
    """
    layer = MultiHeadSelfAttention(d_model, num_heads, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight)
    return layer(in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    mha = MultiHeadSelfAttention(
        d_model, num_heads, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, max_seq_len, theta
    )
...
def run_rmsnorm(
    ...
    """
    layer = RMSNorm(d_model, eps, weights, device=weights.device)
    return layer(in_features)
