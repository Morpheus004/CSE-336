...
- **Qwen 3.5-0.8B (optimized)** Model with access to kernels like flash_linear_attention etc.  
> Calculations and more about optimised version in [model.md](./src/increasing_context/model.md)
## Analysis
